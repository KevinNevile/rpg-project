...
<template>
  ...
  <div class="main mt-5 d-flex justify-content-center align-items-center col-md-12 bg-img bg-cover has-bg-img " style="background-image:url('../src/assets/StoneWall12.svg')">
